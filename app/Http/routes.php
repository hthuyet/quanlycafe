...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::group(array('prefix' => 'admin', 'middleware' => 'SentinelAdmin'), function () {
        ...
        Route::group(array('prefix' => 'groups'), function () {
            Route::any('groups/getPermission/{id}', array('as' => 'admin.groups.getPermission', 'uses' => 'GroupsController@getPermission'));
            Route::post('groups/savePermissions', array('as' => 'admin.groups.savePermissions', 'uses' => 'GroupsController@savePermissions'));
        ...
        Route::group(array('prefix' => 'file'), function () {
            Route::post('create', array('as' => 'file/create', 'uses' => 'FileController@store'));
            Route::post('createmulti', array('as' => 'file/createmulti', 'uses' => 'FileController@postFilesCreate'));
            Route::delete('delete', array('as' => 'file/delete', 'uses' => 'FileController@delete'));
        });

        Route::get('crop_demo', function () {
            return redirect('admin/imagecropping');
        })->name("crop_demo");
        Route::post('crop_demo', array('as' => 'crop_demo', 'uses' => 'JoshController@crop_demo'));

        /* laravel example routes */
        # datatables
        Route::get('datatables', array('as' => 'admin.datatables', 'uses' => 'DataTablesController@index'));
        Route::get('datatables/data', array('as' => 'admin.datatables.data', 'uses' => 'DataTablesController@data'));

        //tasks section
        Route::post('task/create', array('as' => 'task/create', 'uses' => 'TaskController@store'));
        Route::get('task/data', array('as' => 'task/data', 'uses' => 'TaskController@data'));
        Route::post('task/{task}/edit', array('as' => 'task/edit', 'uses' => 'TaskController@update'));
        Route::post('task/{task}/delete', array('as' => 'task/delete', 'uses' => 'TaskController@delete'));
        ...
        Route::get('{name?}', array('as' => 'showView', 'uses' => 'JoshController@showView'));
    });
