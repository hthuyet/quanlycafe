        ...
        <div class="panel panel-primary ">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    @if(Sentinel::hasAccess('admin') || Sentinel::hasAccess('admin/hoadon/create'))
...
<script type="text/javascript">
    function deleteHD(item) {
        ...
        var url = '{{ route("admin.hoadon.confirm-delete", ":id") }}';
...
<script>
    ...
    var accessDelete = "{{ Sentinel::hasAccess('admin.hoadon.delete') }}";
    var accessEdit = "{{ Sentinel::hasAccess('admin.hoadon.save') }}";
    var accessShow = "{{ Sentinel::hasAccess('admin.hoadon.show') }}";
    ...
    function initDataTable() {
        var table = $('#table').DataTable({
            ...
            "order": [[0, "desc"]],
            ajax: {
                url: "{{ route('admin.hoadon.getAjax') }}",
                method: "POST",
                data: function (d) {
