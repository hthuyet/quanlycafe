        ...
        <div class="panel panel-primary ">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    @if(Sentinel::hasAccess('admin') || Sentinel::hasAccess('admin/ban/create'))
...
<script type="text/javascript">
    function deleteBan(item) {
        ...
        var url = '{{ route("admin.ban.confirm-delete", ":id") }}';
...
<script>
    ...
    var accessDelete = "{{ Sentinel::hasAccess('admin.ban.delete') }}";
    var accessEdit = "{{ Sentinel::hasAccess('admin.ban.save') }}";
    var accessShow = "{{ Sentinel::hasAccess('admin.ban.show') }}";
