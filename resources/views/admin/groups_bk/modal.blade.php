{!! Form::open(['route' => ['admin.groups.savePermissions'],'id' => 'roleForm']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 display-no" style="display: block;">
                        <div class="form-group ui-draggable-handle" style="position: static;">
                            <label for="name">{!! trans('groups/form.name') !!}</label>
                    ...
                    <div class="col-md-12 display-no" style="display: block;">
                        <div class="form-group ui-draggable-handle" style="position: static;">
                            <label for="listPermissions">{!! trans('groups/form.permission') !!}</label>
...
<script type="text/javascript">
    ...
    $('#btnSaveRole').click(function (e) {
        ...
        $.ajax({
            method: "POST",
            url: "{{ route('admin.groups.savePermissions') }}",
            data: data,
            success: function (response) {
                ...
                //redirect to index
                window.location.href = "{{ URL::to('admin/groups') }}";
        ...
        $("#roleForm").bootstrapValidator({
            fields: {
                name: {
                    validators: {
                        notEmpty: {
                            message: messageRequired.replace(':attribute', '{!! trans("groups/form.name") !!}')
                        }
                    },
                    required: true,
                    rangelength: [6, 16],
