                                            ...
                                            <div class="row">
                                                <div class="nopadmar">
                                                    <div class="col-xs-4 no-padding col-md-3 col-lg-2">
                                                        <a href="<?php echo e(URL::to('admin/reply')); ?>" class="btn btn-sm btn-primary">
                                                            <span class="livicon" data-n="redo" data-s="12" data-c="white" data-hc="white"></span>
                                                            &nbsp;&nbsp;Reply
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-4 no-padding col-md-3 col-lg-2">
                                                        <a href="<?php echo e(URL::to('admin/forward')); ?>" class="btn btn-sm btn-success">
                                                            <span class="livicon" data-n="upload" data-s="12" data-c="white" data-hc="white"></span>
                                                            &nbsp;&nbsp;Forward
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-4 col-md-3 col-lg-2">
                                                        <a href="<?php echo e(URL::to('admin/inbox')); ?>" class="btn btn-sm btn-warning">
