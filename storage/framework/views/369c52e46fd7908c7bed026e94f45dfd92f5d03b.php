...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('admin/inbox')); ?>">Email</a>
                    </li>
                                ...
                                <tbody>
                                    <tr data-messageid="1" class="unread">
                                        ...
                                        <td style="width:56%;" class="view-message ">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">Fwd: Make changes as needed</a>
                                        </td>
                                    ...
                                    <tr data-messageid="2" class="unread">
                                        ...
                                        <td class="view-message">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">Ya comin' to our July webinar?</a>
                                        </td>
                                    ...
                                    <tr data-messageid="3">
                                        ...
                                        <td class="view-message">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">Mobile-First Type & Layout</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>"></a>
                                        </td>
                                    ...
                                    <tr data-messageid="4">
                                        ...
                                        <td class="view-message">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">This looks like borrows page</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>"></a>
                                        </td>
                                    ...
                                    <tr data-messageid="6">
                                        ...
                                        <td class="view-message">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">Analysis on Views</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">
                                                <i class="fa fa-paperclip"></i>
                                    ...
                                    <tr data-messageid="10">
                                        ...
                                        <td class="view-message view-message">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">Make changes as needed</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>"></a>
                                        </td>
                                    ...
                                    <tr data-messageid="11">
                                        ...
                                        <td class="view-message">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">Welcome back to here</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>"></a>
                                        </td>
                                    ...
                                    <tr data-messageid="12">
                                        ...
                                        <td class="view-message">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">Dolor sit amet, consectetuer adipiscing</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="<?php echo e(URL::to('admin/view_mail')); ?>">
                                                <i class="fa fa-paperclip"></i>
