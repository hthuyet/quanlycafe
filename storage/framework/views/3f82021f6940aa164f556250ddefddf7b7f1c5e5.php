<?php echo Form::open(['route' => ['admin.roles.savePermissions'],'id' => 'roleForm']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 display-no" style="display: block;">
                        <div class="form-group ui-draggable-handle" style="position: static;">
                            <label for="name"><?php echo trans('roles/form.name'); ?></label>
                    ...
                    <div class="col-md-12 display-no" style="display: block;">
                        <div class="form-group ui-draggable-handle" style="position: static;">
                            <label for="listRoutes"><?php echo trans('roles/form.route'); ?></label>
...
<script type="text/javascript">
    ...
    $('#btnSaveRole').click(function (e) {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo e(route('admin.roles.savePermissions')); ?>",
            data: data,
        ...
        $("#roleForm").bootstrapValidator({
            fields: {
                name: {
                    validators: {
                        notEmpty: {
                            message: messageRequired.replace(':attribute', '<?php echo trans("roles/form.name"); ?>')
                        }
                    },
                    required: true,
                    rangelength: [6, 16],
