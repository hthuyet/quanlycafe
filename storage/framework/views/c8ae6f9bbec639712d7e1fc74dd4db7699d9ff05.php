        ...
        <div class="panel panel-primary ">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    <?php if(Sentinel::hasAccess('admin') || Sentinel::hasAccess('admin/sanpham/create')): ?>
...
<script type="text/javascript">
    var accessDelete = "<?php echo e(Sentinel::hasAccess('admin.sanpham.delete')); ?>";
    var accessEdit = "<?php echo e(Sentinel::hasAccess('admin.sanpham.saveSp')); ?>";
    var accessShow = "<?php echo e(Sentinel::hasAccess('admin.sanpham.show')); ?>";
    
    function deleteSanPham(item) {
        var obj = $(item).data("obj");
        var url = '<?php echo e(route("admin.sanpham.confirm-delete", ":id")); ?>';
...
<script>
    ...
    function initDataTable() {
        var table = $('#table').DataTable({
            ...
            "order": [[0, "desc"]],
            ajax: {
                url: "<?php echo e(route('admin.sanpham.getAjax')); ?>",
                method: "POST",
                data: function (d) {
...
<?php echo $__env->make('admin.sanpham.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
