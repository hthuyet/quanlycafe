...
<?php $__env->startSection('header_styles'); ?>    
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendors/Jcrop/css/jquery.Jcrop.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/pages/cropcustom.css')); ?>" type="text/css" />
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab_1" style="padding:10px;">
                                                <div class="col-md-8">
                                                    ...
                                                    <img src="<?php echo e(asset('assets/img/cropping-image.jpg')); ?>" class="img-responsive" id="target1" alt="[Jcrop Example]" />
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="tab-pane" id="tab_2" style="padding:10px;">
                                                <div class="col-md-8">
                                                    <img src="<?php echo e(asset('assets/img/cropping-image.jpg')); ?>" class="img-responsive" width="600px" id="target2" alt="[Jcrop Example]" />
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="tab-pane" id="tab_3" style="padding:10px;">
                                                <img src="<?php echo e(asset('assets/img/cropping-image.jpg')); ?>" class="img-responsive" id="target3" alt="[Jcrop Example]" />
                                                <div id="preview-pane">
                                                    <div class="preview-container">
                                                        <img src="<?php echo e(asset('assets/img/cropping-image.jpg')); ?>" class="jcrop-preview" alt="Preview" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /.tab-pane 3-->
                                            <div class="tab-pane" id="tab_4" style="padding:10px;">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <img src="<?php echo e(asset('assets/img/cropping-image.jpg')); ?>" class="img-responsive"  width="595px" id="target4" alt="[Jcrop Example]" />
                                                    </div>
                                                    <div class="col-md-4">
                                            ...
                                            <div class="tab-pane" id="tab_5" style="padding:10px;">
                                                <div class="col-md-8">
                                                    <img src="<?php echo e(asset('assets/img/cropping-image2.png')); ?>" width="595px" height="400%" class="img-responsive" id="target5" alt="[Jcrop Example]" />
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="tab-pane" id="tab_6" style="padding:10px;">
                                                <div class="col-md-8">
                                                    <img src="<?php echo e(asset('assets/img/cropping-image.jpg')); ?>" class="img-responsive" width="600px" id="target6" alt="[Jcrop Example]" />
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="tab-pane" id="tab_8" style="padding:10px;">
                                                <div class="col-md-8">
                                                    <img src="<?php echo e(asset('assets/img/cropping-image.jpg')); ?>" width="600px" class="img-responsive" id="cropbox" />
                                                </div>
                                                <div class="col-md-4">
                                                    <form action="<?php echo e(URL::to('admin/crop_demo')); ?>" method="post" onsubmit="return checkCoords();">
                                                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/vendors/Jcrop/js/jquery.Jcrop.min.js')); ?>" ></script>
    <script src="<?php echo e(asset('assets/vendors/Jcrop/js/jquery.color.js')); ?>" ></script>
    <script src="<?php echo e(asset('assets/js/pages/cropcustom.js')); ?>" ></script>
